...
4. UI of a Webpage
A React project focused on UI development using Tailwind CSS.
Goals:
Build responsive webpage UI components.
Practice modern styling techniques with Tailwind CSS.
5. User App
An application for searching and viewing users.
Features:
...
6. React-Hook
Understanding how  useState hook work . i made counter with
increase and decrease button to change counts with useState.

7. Notes-App-Project
In this i made complete add new task and delete task operations
with a Modern & responsive Ui With Tailwind CSS. 
